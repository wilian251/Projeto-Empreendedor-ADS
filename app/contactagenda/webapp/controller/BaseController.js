sap.ui.define([
    ...
    return Controller.extend("finalproject.app.contactagenda.controller.BaseController", {
        /**
        ...
        onShareEmailPress : function () {
            var oViewModel = (this.getModel("objectView") || this.getModel("main"));
        ...
        _clearFormatting: function(sValue) {
			if(sValue != "")
				return Number(String(sValue).replaceAll(/([^\d])+/gim, ""))
			else return 0;
		},
